    ...
    const observer = new MutationObserver((mutations) => {
        mutations.forEach((mutation) => {
            if (
                ...
                // your logic to change the SVG color based on the theme goes here
            }
        });
    });
...
<Link class="text-2xl normal-case btn btn-ghost" href="/">
    {#if currentTheme == "cmyk"}
        <svg
            ...
            width="40px"
            height="40px"
            viewBox="0 0 590.000000 675.000000"
        ...
        >
            ...
            >
                <path
                    d="M2777 6729 c-128 -14 -260 -69 -355 -147 -102 -83 -137 -240 -92
    ...
    -144 259 2 36 9 49 38 72 64 52 184 70 306 48z"
                />
                <path
                    d="M2820 1460 l0 -1450 1535 0 1535 0 0 1450 0 1450 -1535 0 -1535 0 0
    -1450z"
                />
            </g>
        </svg>
